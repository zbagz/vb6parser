package io.proleap.vb6.asg.newtests.c;
...
public class TestC extends VbTestBase {

    @Test
    public void test() throws Exception {
        final File clsListInputFile = new File(
                "src/test/resources/io/proleap/vb6/asg/newtests/c/clsList.cls");
        
        final File clsListNodeInputFile = new File(
                "src/test/resources/io/proleap/vb6/asg/newtests/c/clsListNode.cls");      

        final Program program = new VbParserRunnerImpl().analyzeFiles(Arrays.asList(clsListInputFile, clsListNodeInputFile));
